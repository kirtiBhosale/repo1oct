...
/*  Unit Testing comes as default for this codebase. Mocha is used to run the Unit
    Tests, this test is being called from 'npm test'. Hooks in Istanbul in this process
    to generate static reports and also a command line feedback
*/
...
gulp.task('lint', () => {
  return gulp.src(['**/**/*.js', '!node_modules/**', '!lib/**', '!src/public/js/bundle.js', '!src/public/vendor/*.js', '!tests/**'])
...
// gulp.task('build', ['babelify-server-controllers', 'fonts', 'image',
// 'babelify-routes', 'sass', 'browserify', 'minify-js-vendor', 'minify-css-vendor']);
gulp.task('build', ['babelify-server-controllers', 'fonts', 'image', 'babelify-routes', 'sass', 'browserify', 'minify-js-vendor', 'minify-css-vendor']);
/*  -----------------------  */
