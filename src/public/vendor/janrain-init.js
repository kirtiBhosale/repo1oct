...
(function() {
    ...
    janrain.settings.appUrl = 'https://elanco-dev.rpxnow.com/';
    ...
    janrain.settings.capture.appId = 'etjq8fgtv4362yvdegguu43uew';
    janrain.settings.capture.captureServer = 'https://elanco-dev.janraincapture.com';
    janrain.settings.capture.redirectUri = 'http://localhost/';
    janrain.settings.capture.clientId = 'ttadj2subsct6cwseesfbkjhke2xmzsr'; //us
